        ...
        <Grid className={styles.grid2}>
          ...
          <GridItem className={styles.gridItem2}>
            <Image
              ...
              src="https://www.getharvest.com/hs-fs/hubfs/screenshot-features-timesheets.png?width=787&name=screenshot-features-timesheets.png"
            />
          </GridItem>
          <GridItem></GridItem>
          <GridItem>
        ...
        <Grid className={styles.grid3}>
          <GridItem>
            <Image
              ...
              src="https://www.getharvest.com/hs-fs/hubfs/site-images/features-quote-1.jpg?width=375&name=features-quote-1.jpg"
            />
          </GridItem>
          <GridItem className={styles.gridItem3}>
            <Text className={styles.text6}>
              Harvest’s easy, clean time tracking allows us to focus on the
              tough engineering problems where we bring value to our clients.
            </Text>
            <Text className={styles.text7}>Genevieve Laing</Text>
            <Text className={styles.text8}>
