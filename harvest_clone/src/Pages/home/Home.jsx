        ...
        <Box className={styles.TimeTracking}>
          <Box className={styles.TimeTracking_box1}>
            ...
            <Box className={styles.TimeTracking_Sbox2}>
              <Text
                noOfLines={[1, 2]}
                className={styles.TimeTracking_Sbox2_txt1}
              >
                Time tracking your team wants to use
              </Text>
              <Text className={styles.TimeTracking_Sbox2_txt2}>
                Finally, an easy way to track time across projects. Reports,
                invoicing, and more. All in just a few clicks.
              </Text>
            </Box>

            <Box className={styles.TimeTracking_Sbox3}>
              <Input
                className={styles.TimeTracking_Sbox3_inp}
                variant="outline"
                width="60%"
                size="lg"
                bg="white"
              ...
              <Text className={styles.TimeTracking_Sbox3_txt1}>
          ...
          <Box className={styles.TimeTracking_box2}>
            <Image
              className={styles.TimeTracking_box2_img}
